...
// 1，hash后的密码对象pass。pass, err := hash.NewHashedPassword("12345678mM@1")
// 2，调用CheckPassword方法进行密码校验。pass.CheckPassword("sdfsdf")
// 3，func (p *Password) 表明了这个方法属于Password结构体(类)，只有他的对象才能调用
